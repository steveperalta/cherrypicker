...
@XmlType(name="ConnectionEnum")
@XmlEnum(String.class)
public enum ConnectionEnum {

@XmlEnumValue("ANYWHERE") ANYWHERE(String.valueOf("ANYWHERE")), @XmlEnumValue("ZONE") ZONE(String.valueOf("ZONE"));
    ...
    public static ConnectionEnum fromValue(String v) {
